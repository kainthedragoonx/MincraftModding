...
public class CustumItem extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:custum")
	public static final Item block = null;
	public CustumItem(FamilymodtimeModElements instance) {
		super(instance, 37);
	}
