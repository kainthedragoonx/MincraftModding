...
public class RedsmilifacecookieItem extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:redsmilifacecookie")
	public static final Item block = null;
	public RedsmilifacecookieItem(FamilymodtimeModElements instance) {
		super(instance, 36);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("redsmilifacecookie");
		}
