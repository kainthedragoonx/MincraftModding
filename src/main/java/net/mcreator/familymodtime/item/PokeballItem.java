...
public class PokeballItem extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:pokeball")
	public static final Item block = null;
	public PokeballItem(FamilymodtimeModElements instance) {
		super(instance, 33);
	}
