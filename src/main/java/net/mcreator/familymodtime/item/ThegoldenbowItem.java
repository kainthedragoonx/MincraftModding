...
import net.mcreator.familymodtime.block.VenusflytrapBlock;
import net.mcreator.familymodtime.FamilymodtimeModElements;

import java.util.Random;

@FamilymodtimeModElements.ModElement.Tag
public class ThegoldenbowItem extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:thegoldenbow")
	public static final Item block = null;
	@ObjectHolder("familymodtime:entitybulletthegoldenbow")
	public static final EntityType arrow = null;
	public ThegoldenbowItem(FamilymodtimeModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletthegoldenbow").setRegistryName("entitybulletthegoldenbow"));
	}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(VenusflytrapBlock.block, (int) (1)).getItem()) {
						slotID = i;
						break;
					}
				}
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.2000000000000002f, 5, 15);
					itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
					if (entity.abilities.isCreativeMode) {
						entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
					} else {
						ItemStack stack = entity.inventory.getStackInSlot(slotID);
						if (new ItemStack(VenusflytrapBlock.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(VenusflytrapBlock.block, (int) (1));
		}
