...
public class AcidBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("familymodtime:acid_bucket")
	public static final Item bucket = null;
	private FlowingFluid flowing = null;
	private FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public AcidBlock(FamilymodtimeModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("familymodtime:blocks/acid2"), new ResourceLocation("familymodtime:blocks/acid2"))
						.luminosity(6).density(1000).viscosity(1006).gaseous()).bucket(() -> bucket).block(() -> block);
