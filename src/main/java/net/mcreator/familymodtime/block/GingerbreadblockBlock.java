...
public class GingerbreadblockBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:gingerbreadblock")
	public static final Block block = null;
	public GingerbreadblockBlock(FamilymodtimeModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gingerbreadblock");
		}
