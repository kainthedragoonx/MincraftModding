...
public class VenusflytrapBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:venusflytrap")
	public static final Block block = null;
	public VenusflytrapBlock(FamilymodtimeModElements instance) {
		super(instance, 16);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("SNAP! dont get near!"));
		}
