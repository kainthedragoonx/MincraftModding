...
public class PokeballblockBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:pokeballblock")
	public static final Block block = null;
	public PokeballblockBlock(FamilymodtimeModElements instance) {
		super(instance, 32);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("pokeballblock", "pokeballblock", blockAt -> {
