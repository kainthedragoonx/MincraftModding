...
public class RawDragonmagicBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:raw_dragonmagic")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("familymodtime:raw_dragonmagic_bucket")
	public static final Item bucket = null;
	private FlowingFluid flowing = null;
	private FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public RawDragonmagicBlock(FamilymodtimeModElements instance) {
		super(instance, 30);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("familymodtime:blocks/rawdragonmagic"), new ResourceLocation("familymodtime:blocks/rawdragonmagic"))
				.luminosity(0).density(1000).viscosity(1000).gaseous()).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("raw_dragonmagic");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("raw_dragonmagic_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.LAVA)) {
		}.setRegistryName("raw_dragonmagic"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("raw_dragonmagic_bucket"));
	}
