...
public class BonedragonbonesBlock extends FamilymodtimeModElements.ModElement {
	@ObjectHolder("familymodtime:bonedragonbones")
	public static final Block block = null;
	public BonedragonbonesBlock(FamilymodtimeModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bonedragonbones");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("bonedragonbones", "bonedragonbones", blockAt -> {
