...
public class EeveeEntity extends FamilymodtimeModElements.ModElement {
	public static EntityType entity = null;
	public EeveeEntity(FamilymodtimeModElements instance) {
		super(instance, 34);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 0.9f)).build("eevee")
						.setRegistryName("eevee");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -13421824, -13421824, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("eevee"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new PigModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("familymodtime:textures/brown.png");
			}
		});
	}
