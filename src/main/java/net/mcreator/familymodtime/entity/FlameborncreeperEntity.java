...
import net.mcreator.familymodtime.item.FlamebornswordItem;
import net.mcreator.familymodtime.FamilymodtimeModElements;

import java.util.Random;

@FamilymodtimeModElements.ModElement.Tag
public class FlameborncreeperEntity extends FamilymodtimeModElements.ModElement {
	public static EntityType entity = null;
	public FlameborncreeperEntity(FamilymodtimeModElements instance) {
		super(instance, 7);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.7f))
						.build("flameborncreeper").setRegistryName("flameborncreeper");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -65536, -65536, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("flameborncreeper"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new CreeperModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("familymodtime:textures/image.png");
			}
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FlamebornswordItem.block, (int) (1)));
		}
